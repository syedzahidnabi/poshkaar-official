...
const siteUrl = "https://poshkaarkashmir.com";
...
export const metadata: Metadata = {
  ...
  twitter: {
    ...
    title: "Poshkaar Kashmir | Luxury Handcrafted Couture",
    description:
      "Handcrafted Tilla, Zari, Aari and Dabka fashion inspired by Kashmir.",
...
export default function RootLayout({
  ...
  const orgSchema = {
    ...
    description:
      "Luxury handcrafted Kashmiri couture featuring Tilla, Zari, Aari and Dabka embroidery.",
    sameAs: ["https://www.instagram.com/posh__kaar"],
  };
