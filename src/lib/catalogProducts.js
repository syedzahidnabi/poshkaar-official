...
const AARI_PRODUCTS = [
  ...
  makeProduct({
    craft: 'Aari',
    number: 3,
    title: 'Crimson Garden Aari Pheran',
    color: 'Crimson',
    price: 14500,
    bestseller: true,
    images: [
      '/images/products/aari/generated/aari3-clean-front.png',
      '/images/products/aari/generated/aari3-angle-side.png',
      '/images/products/aari/generated/aari3-angle-detail.png',
    ],
  }),
  makeProduct({
    craft: 'Aari',
    number: 4,
    title: 'Cobalt Gold Aari Pheran',
    color: 'Cobalt blue',
    price: 14500,
    images: [
      '/images/products/aari/generated/aari4-clean-front.png',
      '/images/products/aari/generated/aari4-angle-side.png',
      '/images/products/aari/generated/aari4-angle-detail.png',
    ],
  }),
  makeProduct({
    craft: 'Aari',
    number: 5,
    title: 'Ivory Rose Aari Pheran',
    color: 'Ivory & rose',
    price: 12500,
    images: [
      '/images/products/aari/generated/aari5-clean-front.png',
      '/images/products/aari/generated/aari5-angle-side.png',
      '/images/products/aari/generated/aari5-angle-detail.png',
    ],
  }),
  makeProduct({
    craft: 'Aari',
    number: 6,
    title: 'Ivory Indigo Aari Pheran',
    color: 'Ivory & indigo',
    price: 12500,
    images: [
      '/images/products/aari/generated/aari6-clean-front.png',
      '/images/products/aari/generated/aari6-angle-side.png',
      '/images/products/aari/generated/aari6-angle-detail.png',
    ],
  }),
  makeProduct({
    craft: 'Aari',
    number: 7,
    title: 'Sand Garden Aari Pheran',
    color: 'Sand',
    price: 13500,
    images: [
      '/images/products/aari/generated/aari7-clean-front.png',
      '/images/products/aari/generated/aari7-angle-side.png',
      '/images/products/aari/generated/aari7-angle-detail.png',
    ],
  }),
  makeProduct({
    craft: 'Aari',
    number: 8,
    title: 'Teal Saffron Aari Pheran',
    color: 'Teal & saffron',
    price: 14500,
    bestseller: true,
    images: [
      '/images/products/aari/generated/aari8-clean-front.png',
      '/images/products/aari/generated/aari8-angle-side.png',
...
const TILLA_PRODUCTS = [
  ...
  makeProduct({
    craft: 'Tilla',
    number: 3,
    title: 'Emerald Silver Tilla Ensemble',
    color: 'Emerald',
    price: 24500,
    detailCount: 2,
    category: 'Bridal',
    bestseller: true,
    images: [
      '/images/products/tilla/generated/tilla3-clean-front.png',
      '/images/products/tilla/generated/tilla3-angle-side.png',
  ...
  makeProduct({
    craft: 'Tilla',
    number: 6,
    title: 'Plum Silver Tilla Ensemble',
    color: 'Plum',
    price: 22500,
    detailCount: 1,
    images: [
      '/images/products/tilla/generated/tilla6-clean-front.png',
      '/images/products/tilla/generated/tilla6-angle-side.png',
      '/images/products/tilla/generated/tilla6-angle-detail.png',
    ],
  }),
  makeProduct({
    craft: 'Tilla',
    number: 7,
    title: 'Aqua Rose Tilla Ensemble',
    color: 'Aqua',
    price: 23500,
    detailCount: 1,
    images: [
      '/images/products/tilla/generated/tilla7-clean-front.png',
      '/images/products/tilla/generated/tilla7-angle-side.png',
...
const DABKA_PRODUCTS = [
  ...
  makeProduct({
    craft: 'Dabka',
    number: 2,
    title: 'Burnished Copper Dabka Ensemble',
    color: 'Burnished copper',
    price: 21500,
    detailCount: 1,
    images: [
      '/images/products/dabka/generated/dabka2-clean-front.png',
      '/images/products/dabka/generated/dabka2-angle-side.png',
      '/images/products/dabka/generated/dabka2-angle-detail.png',
    ],
  }),
  makeProduct({
    craft: 'Dabka',
    number: 3,
    title: 'Saffron Dabka Ensemble',
    color: 'Saffron',
    price: 19500,
    detailCount: 2,
    images: [
      '/images/products/dabka/generated/dabka3-clean-front.png',
      '/images/products/dabka/generated/dabka3-angle-side.png',
      '/images/products/dabka/generated/dabka3-angle-detail.png',
    ],
  }),
  makeProduct({
    craft: 'Dabka',
    number: 4,
    title: 'Sand Rose Dabka Ensemble',
    color: 'Sand & rose',
    price: 24500,
    detailCount: 1,
    category: 'Bridal',
    images: [
      '/images/products/dabka/generated/dabka4-clean-front.png',
      '/images/products/dabka/generated/dabka4-angle-side.png',
  ...
  makeProduct({
    craft: 'Dabka',
    number: 6,
    title: 'Forest Dabka Cape',
    color: 'Forest green',
    price: 23500,
    detailCount: 1,
    images: [
      '/images/products/dabka/generated/dabka6-clean-front.png',
      '/images/products/dabka/generated/dabka6-angle-side.png',
