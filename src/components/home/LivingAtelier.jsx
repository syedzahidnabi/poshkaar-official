...
export default function LivingAtelier() {
  ...
  return (
    <section className="relative overflow-hidden bg-[#171513] py-16 text-ivory md:py-24" aria-labelledby="living-atelier-title">
      ...
      <div className="relative mx-auto max-w-7xl px-6 md:px-12 lg:px-16">
        <div className="grid gap-10 lg:grid-cols-[0.82fr_1.18fr] lg:items-center">
          ...
          >
            ...
            <p className="mt-7 max-w-lg text-sm leading-7 text-ivory/68 md:text-base md:leading-8">
          ...
          >
            ...
            <div className="flex w-max gap-4 animate-marquee">
              {marqueeImages.map((media, index) => (
                <figure
                  key={`${media.src}-${index}`}
                  className="relative h-72 w-52 shrink-0 overflow-hidden border border-ivory/10 bg-charcoal md:h-96 md:w-64"
                >
                  <img
                    src={media.src}
                    alt={media.alt}
        ...
        <div className="mt-12 grid gap-3 border-t border-ivory/10 pt-7 sm:grid-cols-2 lg:grid-cols-4">
